...
namespace bim_base
{
    public partial class FormTeachMoldPP : Form
    {
        ...
        private void ui_timer_Tick(object sender, EventArgs e)
        {
            ...
            setColor(upperGuideFwdButton, INPUT.MOLD_SHUTTLE_UPPER_GUIDE_FWD_1, INPUT.MOLD_SHUTTLE_UPPER_GUIDE_FWD_2, OUTPUT.SHUTTLE_UPPER_GUIDE_FWD);
            setColor(upperGuideBwdButton, INPUT.MOLD_SHUTTLE_UPPER_GUIDE_BWD_1, INPUT.MOLD_SHUTTLE_UPPER_GUIDE_BWD_2, OUTPUT.SHUTTLE_UPPER_GUIDE_BWD);
        }
