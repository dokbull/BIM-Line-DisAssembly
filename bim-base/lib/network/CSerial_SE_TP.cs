...
public class CSerial_SE_TP
{
    ...
    public CSerial_SE_TP(SerialPort serialPort)
    {
            ...
            for (int i = 0; i < buff.Length; i++)
            {
                ...
                if (buff[i] == ETX)
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        // readData[0] 은 STX이므로 제외
                        Util.memcpy(ref data, 0, readData, 1, dataLength);
    ...
    private void processIncmonig(byte[] data)
    {
        ...
        Debug.debug("CSerial_SE_TP::processIncoming data:" + text);
