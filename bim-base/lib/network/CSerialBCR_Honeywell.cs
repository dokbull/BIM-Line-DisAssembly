...
public class CSerialBCR_Honeywell
{
    static byte STX = 0x16;
    static byte ETX = 0x0D;

    static byte SYN = 0x22;
    static byte CR = 0x13;
    ...
    bool m_useSTX = true; // default true
    bool m_useETX = true;

    public CSerialBCR_Honeywell(SerialPort serialPort)
    {
    ...
    public void setUseSTX(bool value)
    {
        m_useSTX = value;
    }
    ...
    public void sendTriggerHf800(bool value) // HF800 전용
    {
        byte[] cmd = new byte[3];
