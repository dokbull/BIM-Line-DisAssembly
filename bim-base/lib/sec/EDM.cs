...
public class EDM
{
    ...
    public void writeEdm(GEIM_CMD cmd, string extra = "", string jigState = "00000000") // machine status log
    {
        writeGeim(cmd, extra, jigState);
    }

    public void writeEdmProduct(GEIM_CMD cmd, bool isWait, string jigState = "00000000")
    {
        writeGeimProduct(cmd, isWait, jigState);
    }

    public void writeEdmNGProduct(string bcr, string jigNo, string error, string jigState = "00000000")
    {
        writeGeimNGProduct(bcr, jigNo, error, jigState);
    }

    public void writeEdmProductOut(int jigNo, string result, string jigState = "00000000")
    {
        writeGeimProductOut(jigNo, result, jigState);
    }

    public void writeEdmAlarm(int alarm, string jigState = "00000000") // machine alarm log
    {
        writeGeim(alarm, jigState);
    }

    public void writeEdmJig(GEIM_CMD cmd, string jigState, string sub1, string jigNo, string extra = "0")  //jig 사용할 때만 적용함.
    {
        writeGeim(cmd, jigState, sub1, jigNo, extra);
    }
