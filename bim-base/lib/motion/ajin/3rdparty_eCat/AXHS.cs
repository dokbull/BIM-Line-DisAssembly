...
public enum AXT_BASE_BOARD:uint
{
	...
	AXT_PCI_Rxx04RTEX_B0									= 0xC0,	   // PCI bus[PCI9056], Half size, blabla~ 240208 jhy Device 추가
...
public enum AXT_DIO_PORT_TYPE:uint
{
	DIO_PORT_OUTPUT, 
	DIO_PORT_INPORT	
}
...
public enum AXT_MOTION_CONTIOUT_MODE:uint
{
    CONTI_OUT_DISTANCE_MODE                = 0x0,    // 지정한 이동거리 전에 출력제어(노드의 종료위치 기준)
    CONTI_OUT_TIME_MODE                    = 0x1,    // 지정한 시간 전에 출력제어(노드의 종료위치 기준)
    CONTI_OUT_DISTANCE_RATIO_MODE          = 0x2,    // 지정한 이동거리에 대한 비율로 출력제어(노드의 종료위치 기준)
    CONTI_OUT_NODE_START_MODE              = 0x3     // 노드의 시작위치에서 출력제어
}

public enum AXT_MOTION_LINE_MOVE_VEL_MODE:uint
{
...
public enum AXT_MOTION_COMP_TWODIMSET_RESULT : uint
{
	TWODIM_SET_DEFAULT				= 0,
	TWODIM_SET_SUCCESS				= 1,
	TWODIM_SET_SEND_TABLE_INFO_FAIL	= 2,
	TWODIM_SET_SEND_MOTORPOS1_FAIL	= 3,
	TWODIM_SET_SEND_MOTORPOS2_FAIL	= 4,
	TWODIM_SET_SEND_LOADPOS1_FAIL	= 5,
	TWODIM_SET_SEND_LOADPOS2_FAIL	= 6,
	TWODIM_SET_FAIL					= 7
}
...
{
    AXP_MAX_MACRO_SIZE            = 96,
    AXP_MAX_MACRO_NODE_NUM        = 64,
	AXP_MAX_MACRO_SET_ARG         = 21,
	AXP_MAX_MACRO_GET_DATA        = 21,
	AXP_MAX_MACRO_DATA_ARRAY_SIZE = 16
}
...
{
    MACRO_OUTPUT_DIGITAL     = 0,
    MACRO_OUTPUT_ANALOG      = 1,   
    MACRO_OUTPUT_DIGITAL_PDO = 2,
    MACRO_OUTPUT_MOTION      = 3,
    MACRO_OUTPUT_TYPE_MAX    = 4
}
...
public enum AXT_MACRO_SET_DATA_TYPE:uint
{
    ...
    MACRO_DATA_DIGIT        = 6,
    MACRO_DATA_BYTE_ARR     = 7,
    MACRO_DATA_WORD_ARR     = 8,
    MACRO_DATA_DWORD_ARR    = 9,
    MACRO_DATA_VOLTAGE_ARR  = 10,
    MACRO_DATA_DIGIT_ARR    = 11,
    MACRO_DATA_TYPE_MAX     = 12
}
...
public enum AXT_MACRO_START_CONDITION:uint
{
    ...
    MACRO_START_WATCHDOG_TIMEOUT = 2,
    MACRO_START_MAX              = 3
}

public enum AXT_MACRO_RESUME_CONDITION:uint
{
    MACRO_RESUME_WHEN_PAUSED        = 0,   
    MACRO_RESUME_RESERVED           = 1,
    MACRO_RESUME_IGNORE_FUNC_WAIT   = 2,
    MACRO_RESUME_FROM_FIRST_NODE    = 3,
    MACRO_RESUME_MAX                = 4
}

public enum AXT_MACRO_SKIP_CONDITION:uint
{
    MACRO_SKIP_WHEN_FUNC_WAIT   = 1,   
    MACRO_SKIP_WAIT_TO_END      = 2,
    MACRO_SKIP_MAX              = 3
}

public enum AXT_MACRO_PAUSE_CONDITION:uint
{
    MACRO_PAUSE_CLEAR           = 0,
    MACRO_PAUSE_IMMEDIATELY     = 1,   
    MACRO_PAUSE_AT_FUNC_WAIT    = 2,
    MACRO_PAUSE_AT_END          = 3,
    MACRO_PAUSE_MAX             = 4
}
...
public enum AXT_MACRO_ERROR_CODE:uint
{
    ...
    ERROR_INVALID_STOP_MODE         = 10,
    ERROR_INVALID_START_CONDITION   = 11,
	ERROR_INVALID_REPEAT_COUNT		= 12,		
    ERROR_NOT_SUPPORT_MODULE        = 13,
    ERROR_NOT_READY_MACRO           = 14,
	ERROR_EMPTY_NODE				= 15
}
/* Read/Write port							*/
public enum HPC30PORT_DATA_WRITE:uint
{	
...
public enum HPC30PORT_CH_STAUTS:uint
{
	Hpc30Ch1Mech		= 0x20,
	Hpc30Ch1Status	    = 0x22,
	Hpc30Ch2Mech		= 0x30,
...
public enum HPC30PORT_ETC:uint
{
	Hpc30DiIntFlag	    = 0x60,
...
public enum HPC30RAM_DATA:uint
{
...
public enum HPC30COMMAND:uint
{
	...
	Hpc30Table3FifoDataXRead			    = 0x42,				// TB3 FIFO DATA X READ, 3mj 2BIT    
...
public enum AXT_COUNTER_HPC4_TRRIGER_MODE:uint
{
...
public enum AXT_COUNTER_CCGC_TRRIGER_MODE:uint
{
	CCGC_CNT_RANGE_TRIGGER   								=0,		// 1D : Absolute mode, 2D : Error distance check
	CCGC_CNT_VECTOR_TRIGGER  								=1, 	// 2D : rror distance + Vector direction check
	CCGC_CNT_DISTANCE_PERIODIC_TRIGGER						=2,		// 1D,2D : Distance Periodic
	CCGC_CNT_PATTERN_TRIGGER 								=3,		// 1D,2D : Timer mode with cnt limit
	CCGC_CNT_POSITION_ON_OFF_TRIGGER						=4,		// 1D,2D : ON-OFF Trigger (Position)
	CCGC_CNT_AREA_ON_OFF_TRIGGER							=5		// 1D,2D : ON-OFF Trigger (Area)
}

public enum CCGCCNT_TRIGGER_DIMENSION:uint
{
	CCGC_CNT_1D_TRIGGER   								=0,		// 1D Trigger Mode
	CCGC_CNT_2D_TRIGGER   								=1		// 2D Trigger Mode

}

public enum CCGCCNT_COMMAND:uint
{ 
	CcgcCnt_TriggerCount							= 0xF4,				//Trigger Out Count (Only Valid 1D Time Trigger Mode)
	CcgcCnt_Table1EnableWrite	                    = 0x98,				// TB1 TRIGGER ENABLE WRITE , 1BIT
	CcgcCnt_Table1DisableWrite	                    = 0x99,				// TB1 TRIGGER DISABLE WRITE, 1BIT
	CcgcCnt_TriggerEnableRead						= 0x17,				// CH1 TRIGGER ENABLE READ, 1bit	
	CcgcCnt_Table1EncoderInputXWrite				= 0x80,				//TABLE1 ENCODERINPUT X WRITE,2BIT
	CcgcCnt_Table1EncoderInputXRead					= 0x00,				//TABLE1 ENCODERINPUT X READ,2BIT	
	CcgcCnt_Table1EncoderInputYWrite				= 0x84,				//TABLE1 ENCODERINPUT Y WRITE,2BIT
	CcgcCnt_Table1EncoderInputYRead					= 0x04,				//TABLE1 ENCODERINPUT Y READ,2BIT
	CcgcCnt_Table1TriggerModeWrite					= 0x96,				//TABLE1 TRIGGERMODE WRITE,8BIT
	CcgcCnt_Table1TriggerModeRead					= 0x16,				//TABLE1 TRIGGERMODE READ,8BIT
	CcgcCnt_Table1XFifoDataClear					= 0x9F,				//TABLE1 FIFO DATA CLEAR,1BIT
	CcgcCnt_Table1YFifoDataClear					= 0xAF,				//TABLE1 FIFO DATA CLEAR,1BIT
	CcgcCnt_Table1PulseWidthWrite			    	= 0x95,				// TB1 PULSE WDITH WRITE, 32BIT
	CcgcCnt_Table1PulseWidthRead			   		= 0x15,				// TB1 PULSE WDITH READ, 32BIT
	CcgcCnt_Table1ErrorRangeWrite	            	= 0x94,				// TB1 ERROR RANGE WRITE, 32BIT
	CcgcCnt_Table1ErrorRangeRead	            	= 0x14,				// TB1 ERROR RANGE READ, 32BIT
	CcgcCnt_Table1XFifoStatusRead					= 0x1F,				// TB1 FIFO STATUS READ, 16BIT
	CcgcCnt_Table1YFifoStatusRead					= 0x2F,				// TB1 FIFO STATUS READ, 16BIT
	CcgcCnt_Table1XLowerPosWrite					= 0x92,				// TB1 X LOWER POS WRITE,32BIT
	CcgcCnt_Table1XLowerPosRead						= 0x12,				// TB1 X LOWER POS READ,32BIT
	CcgcCnt_Table1YLowerPosWrite					= 0xA2,				// TB1 Y LOWER POS WRITE,32BIT
	CcgcCnt_Table1YLowerPosRead						= 0x22,				// TB1 Y LOWER POS READ,32BIT
	CcgcCnt_Table1XUpperPosWrite					= 0x93,				// TB1 X UPPER POS WRITE,32BIT
	CcgcCnt_Table1XUpperPosRead						= 0x13,				// TB1 X UPPER POS WRITE,32BIT
	CcgcCnt_Table1YUpperPosWrite					= 0xA3,				// TB1 Y UPPER POS WRITE,32BIT
	CcgcCnt_Table1YUpperPosRead						= 0x23,				// TB1 Y UPPER POS WRITE,32BIT
	CcgcCnt_Table1PosPeriodWrite					= 0x94,				// TB1 POS PERIOD WRITE,32BIT
	CcgcCnt_Table1PosPeriodRead						= 0x14,				// TB1 POS PERIOD READ,32BIT
	CcgcCnt_Table1OneShot	                    	= 0x97,				// TB1 ONE SHOT , 1BIT
	CcgcCnt_Table1PatternTimeWrite	            	= 0x9A,				// TB1 PATTERN TRIGGER TIME WRITE, 32BIT
	CcgcCnt_Table1PatternTimeRead	            	= 0x1A,				// TB1 PATTERN TRIGGER TIME READ, 32BIT
	CcgcCnt_Table1OutputCountRead					= 0x70,				// TB1 OUTPUT COUNT READ, 32BIT
	CcgcCnt_Table1PatternCountWrite					= 0xF4,				// TB1 PATTERN TRIGGER COUNT WRITE, 32BIT
	CcgcCnt_Table1PatternCountRead					= 0x74,				// TB1 PATTERN TRIGGER COUNT READ, 32BIT
	CcgcCnt_Table1TriggerOutputPortXWrite			= 0x9B,				// TB1 TRIGGEROUTPUTPORT X WRITE,4BIT
	CcgcCnt_Table1TriggerOutputPortXRead			= 0x1B,				// TB1 TRIGGEROUTPUTPORT X READ,4BIT
	CcgcCnt_Table1TriggerOutputPortYWrite			= 0xAB,				// TB1 TRIGGEROUTPUTPORT Y WRITE,4BIT
	CcgcCnt_Table1TriggerOutputPortYRead			= 0x2B,				// TB1 TRIGGEROUTPUTPORT Y READ,4BIT
	CcgcCnt_Table2TriggerOutputPortXWrite			= 0xBB,				// TB2 TRIGGEROUTPUTPORT X WRITE,4BIT
	CcgcCnt_Table2TriggerOutputPortXRead			= 0x3B,				// TB2 TRIGGEROUTPUTPORT X READ,4BIT
	CcgcCnt_Table2TriggerOutputPortYWrite			= 0xCB,				// TB2 TRIGGEROUTPUTPORT Y WRITE,4BIT
	CcgcCnt_Table2TriggerOutputPortYRead			= 0x4B,				// TB2 TRIGGEROUTPUTPORT Y READ,4BIT
	CcgcCnt_Table1FifoDataXPosWrite	           		= 0x9E,				// TB1 FIFO DATA X POS WRITE, 32BIT
	CcgcCnt_Table1FifoDataXPosRead	           		= 0x1E,				// TB1 FIFO DATA X POS READ, 32BIT
	CcgcCnt_Table1FifoDataYPosWrite	            	= 0xAE,				// TB1 FIFO DATA Y POS WRITE, 32BIT
	CcgcCnt_Table1FifoDataYPosRead	            	= 0x2E,				// TB1 FIFO DATA Y POS READ, 32BIT
	CcgcCnt_Table1FifoDataXUnitVectorWrite	        = 0xD2,				// TB1 FIFO DATA X UNITVECTOR WRITE, 32BIT
	CcgcCnt_Table1FifoDataYUnitVectorWrite	        = 0xD3,				// TB1 FIFO DATA Y UNITVECTOR WRITE, 32BIT
	CcgcCnt_Table1FifoStatusXRead					= 0x1F,				//TABLE1 X FIFO STATUS READ,16BIT
	CcgcCnt_Table1FifoStatusYRead					= 0x2F,				//TABLE1 Y FIFO STATUS READ,16BIT
	CcgcCnt_Table1OutputCountClear					= 0xF0,				//TABLE1 X TRIGGER OUTPUT CLEAR,1BIT
	CcgcCnt_Table1DimensionWrite					= 0xFE,				//TABLE1 DIMENSION(1D or 2D) WRITE, 1BIT
	CcgcCnt_Table1DimensionRead						= 0x7E,				//TABLE1 DIMENSION(1D or 2D) READ, 1BIT
	CcgcCnt_Table2EncoderInputXWrite				= 0x88,				//TABLE2 ENCODERINPUT X WRITE,2BIT
	CcgcCnt_Table2EncoderInputXRead					= 0x08,				//TABLE2 ENCODERINPUT X READ,2BIT	
	CcgcCnt_Table2EncoderInputYWrite				= 0x8C,				//TABLE2 ENCODERINPUT Y WRITE,2BIT
	CcgcCnt_Table2EncoderInputYRead					= 0x0C,				//TABLE2 ENCODERINPUT Y READ,2BIT
	CcgcCnt_Table2DimensionWrite					= 0xFF,				//TABLE2 DIMENSION(1D or 2D) WRITE, 1BIT
	CcgcCnt_Table2DimensionRead						= 0x7F,				//TABLE2 DIMENSION(1D or 2D) READ, 1BIT
	CcgcCnt_Table2TriggerModeWrite					= 0xB6,				//TABLE2 TRIGGERMODE WRITE,8BIT	
	CcgcCnt_Table2TriggerModeRead					= 0x36				//TABLE2 TRIGGERMODE READ,8BIT	
}

public enum AXT_INTERLOCK_PORT_TYPE:uint
{
	INTERLOCK_PORT_TYPE_OUTPUT		                        = 0,
	INTERLOCK_PORT_TYPE_INPUT								= 1
}

public enum AXT_INTERLOCK_CONDITION:uint
{
...
public enum AXT_INTERLOCK_OUTPUT_MODE:uint
{
...
public struct SIIIHBoardInfo
{
	public bool bIsSIIIHBoard;		        // SIIIH 보드인 경우 TRUE, 아니면 FALSE
	public int lNodeCount; 			        // 해당 보드에 연결된 Node 개수
}

public struct SCAN_RESULT
{
    public const int MAX_BOARD_COUNT = 20;
	public int lTotalBoardCount; 		    //SIIIH 포함 장착된 전체 보드 개수
	public SIIIHBoardInfo[] BoardInfo;      // MAX_BOARD_COUNT 20
	
    public void Initialize()
    {
        lTotalBoardCount = 0;
        BoardInfo = new SIIIHBoardInfo[MAX_BOARD_COUNT];
    }
};

public struct PdoOffset
{
	public uint dwBitOffset;
	public uint dwBitOffsetLength;
}

public struct PdoOffsetData
{
	public PdoOffset[] InputOffs;
	public PdoOffset[] OutputOffs;

	public PdoOffsetData(int arraySize)
    {
        InputOffs = new PdoOffset[arraySize];
        OutputOffs = new PdoOffset[arraySize];
    }
}
...
{
	public int lArraySize;
	public int[] lMultiAxesNo;
	public double[] dMultiPos;
	public double[] dMultiVel;
	public double[] dMultiAccel;
	public double[] dMultiDecel;
	
	public AXT_MOVE_START_MULTI_POS_PARAM(int arraySize)
    {
        lArraySize = arraySize;
        lMultiAxesNo = new int[arraySize];
        dMultiPos = new double[arraySize];
        dMultiVel = new double[arraySize];
        dMultiAccel = new double[arraySize];
        dMultiDecel = new double[arraySize];
    }
}
