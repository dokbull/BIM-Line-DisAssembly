...
public partial class AxisControlPaix : UserControl
{
    ...
    private void absMoveButton_Click(object sender, EventArgs e)
    {
        ...
        m_axis.absMoveWithSpeed(pos, speed);
    }
    ...
    private void orgButton_Click(object sender, EventArgs e)
    {
        ...
        m_axis.setHomeSpeedAccDec(20, 1, 10, 10, 10, 1, 5, 5, 1, 1, 1, 1, 0, 0, 0, 0);
        m_axis.homeMove(PAIX_HOME_MODE.CCW_NEAR, 0.0d);
    }
