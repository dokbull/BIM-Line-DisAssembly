...
public partial class SimpleControlRtex : UserControl
{
    string m_name = "";
    ...
    void selectSpeedButton(SPEED speed)
    {
        ...
        double vel = m_jogSpeed[(int)speed];

        speedTextBox.Text = vel + "";
        m_speed = vel;
    }
    ...
    public virtual void moveButton_Click(object sender, EventArgs e)
    {
        ...
        m_axis.setAbsSpeed(m_speed, m_speed * 10, m_speed * 10);
