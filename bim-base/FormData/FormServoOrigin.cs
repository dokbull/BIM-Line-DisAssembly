...
namespace bim_base
{
    public partial class FormServoOrigin : Form, IViewCloseable
    {
        ...
        private void FormServoOrigin_Load(object sender, EventArgs e)
        {
            InitOriginGrid();
            LoadOrigin();

            MotorOriginGrid.MouseDoubleClick += MotorServoLimitGrid_DoubleClick;
        }

        private void InitOriginGrid()
        {
            CSourceGrid g = MotorOriginGrid;
