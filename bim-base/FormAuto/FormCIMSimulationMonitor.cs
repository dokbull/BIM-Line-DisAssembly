...
namespace bim_base
{
    public partial class FormCIMSimulationMonitor : Form
    {
        ProcessMain main = null;

        public FormCIMSimulationMonitor(ProcessMain procMain)
        {
            InitializeComponent();
        ...
        private void FormCIMSimulationMonitor_Load(object sender, EventArgs e)
        {
