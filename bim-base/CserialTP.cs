...
public class CserialTP
{
    ...
    public CserialTP(SerialPort serialPort)
    {
    ...
    private void run()
    {
        Debug.debug("TPSerial::run START COM:" + m_serialPort.PortName);

        while (true)
        {
            if (m_stop)
            {
                Debug.debug("TPSerial::run STOP");
                break;
            }
            ...
            {
                Debug.critical(ex,
                    "TPSerial::run port:" + m_serialPort.PortName);
            }
    ...
    private void processIncmonig(byte[] data)
    {
        ...
        Debug.debug("TPSerial::processIncoming data:" + text);
